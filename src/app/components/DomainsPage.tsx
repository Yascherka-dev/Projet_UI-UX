...
import { Icon, Reveal, BlueDivider, Magnetic } from './SharedComponents';
...
export function DomainsPage({ onNavigate }: { onNavigate: (page: string) => void }) {
